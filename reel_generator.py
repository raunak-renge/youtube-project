...
class Config:
    ...
    MAX_VIDEO_DURATION: int = 180  # 3 minutes max per source video
...
class VideoDownloader:
    ...
    def download_for_script(self, script: VideoScript) -> Dict[str, List[Path]]:
        """
...
class SceneAnalyzer:
    ...
    def analyze_videos(self, videos: Dict[str, List[Path]]) -> Dict[str, List[SceneInfo]]:
        """
...
class WhisperTranscriber:
    ...
    def transcribe_multiple(self, audio_files: List[Path]) -> List[List[WordTimestamp]]:
...
class ReelGenerator:
    ...
    def generate(self, topic: str, duration: int = 45,
        ...
        print("\n🖼️  Step 8: Generating Thumbnail...")
        thumbnail = self.thumbnail_gen.generate(topic, script.title, final_video)
        if thumbnail:
